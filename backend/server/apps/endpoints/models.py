...
class ABTest(models.Model):
    ...
    Attributes:
        ...
        created_at: The date of the test creation
        ended_at: The date of test stop.
        summary: The description with test summary, created at test stop.
        parent_mlalgorithm_1: The reference to the first corresponsing MLAlgorithm
        parent_mlalgorithm_2: The reference to the second corresponsing MLAlgorithm
    '''
