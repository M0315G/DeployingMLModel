...
class StopABTestView(views.APIView):
    ...
    def post(self, request, ab_test_id, format=None):
        ...
        try:
            ...
            #alg #1 accuracy
            all_responses_1 = MLRequest.objects.filter(parent_mlalgorithmb=AB_test.parent_mlalgorithm_1, created_at__gt=ab_test.created_at, created_at__lt=date_now).count()
            ...
            # alg #2 accuracy
            all_responses_2 = MLRequest.objects.filter(parent_mlalgorithmb=AB_test.parent_mlalgorithm_2, created_at__gt=ab_test.created_at, created_at__lt=date_now).count()
            ...
            status_1 = MLAlgorithmStatus(status="prediction",
                                         created_by=ab_test.creatd_by,
